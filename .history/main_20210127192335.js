...
let interaction = {
  ...
  init:()=>{
    window.onload = interaction.audio.loaded.play()
    mouseLeave();
    interaction.ui.wrapper.addEventListener("mouseenter", smileReady);
    interaction.ui.wrapper.addEventListener("mouseleave", mouseLeave);
  },
  smile: () => {
