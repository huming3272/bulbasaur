...
let interaction = {
  ...
  init:()=>{
    ...
    interaction.ui.wrapper.addEventListener("mouseleave", interaction.mouseLeave);
  },
  smile: () => {
    ...
    interaction.audio.loaded.pause();
    interaction.audio.normal.pause();
