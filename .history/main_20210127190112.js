...
let player = {
  ...
  flag: false,
  smile: () => {
    player.ui.mouth.classList.add("smile");
    player.ui.ball[0].style.left = "-9%";
    player.ui.ball[0].style.top = "10%";
    player.ui.ball[1].style.left = "50%";
    player.ui.ball[1].style.top = "10%";
    // console.log("进来了");
    document.removeEventListener("mousemove", rollEyes);
    player.audio.loaded.load();
    player.audio.normal.load();
    player.audio.smile.play();
    player.flag = true;
  },
};
